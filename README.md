...
| `签到` | 每日签到获取奖励 | `/精灵 签到` |
| `治疗` | 恢复所有精灵HP | `/精灵 治疗` |
| `排行 [类型]` | 查看排行榜（胜场/等级/金币） | `/精灵 排行 胜场` |
| `帮助` | 显示帮助信息 | `/精灵 帮助` |
| **精灵管理** | | |
| `背包` | 查看精灵背包列表 | `/精灵 背包` |
| `队伍` | 查看当前出战队伍 | `/精灵 队伍` |
| `详情 <序号>` | 查看精灵详细数值 | `/精灵 详情 1` |
| `上阵 <序号>` | 从背包上阵精灵到队伍 | `/精灵 上阵 3` |
| `下阵 <位置>` | 将精灵从队伍移回背包 | `/精灵 下阵 2` |
| `进化 <序号>` | 进化指定精灵 | `/精灵 进化 1` |
| `改名 <序号> <新名>` | 修改精灵昵称 | `/精灵 改名 1 小火龙` |
| `放生 <序号>` | 放生精灵（不可逆） | `/精灵 放生 5` |
| **冒险与战斗** | | |
| `区域` | 查看可探索的区域列表 | `/精灵 区域` |
...
| `出售 <物品> [数量]` | 出售物品 | `/精灵 出售 树果 5` |
| `物品` | 查看背包物品 | `/精灵 物品` |
| `使用 <物品> [对象]` | 使用物品 | `/精灵 使用 治疗药水 1` |
| **管理员指令** | | |
| `重载配置` | 热重载游戏配置文件 | `/精灵 重载配置` |
| `统计` | 查看游戏运行统计 | `/精灵 统计` |
